...
class Logger {
     ...
     */
    public static function newMessage(Exception $exception, $print_error = false, $clear = false, $error_file = 'log/errorlog.html') {
     ...
     * @param  string  $error_file  file to save to
     */
    public static function errorMessage($error, $print_error = false, $error_file = 'log/errorlog.html') {
