<?php namespace libraries\phpimageworkshop\Core\Exception;
use libraries\phpimageworkshop\Exception\ImageWorkshopBaseException as ImageWorkshopBaseException;
